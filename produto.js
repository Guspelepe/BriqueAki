...
async function carregarProduto() {
    ...
    try {
        ...
        const tipoTrocaLabel = produto.tipoTroca === 'servico' ? '🛠️ Serviço' : 
                               produto.tipoTroca === 'ambos' ? '📦🛠️ Produto ou Serviço' : '📦 Produto';
        ...
        container.innerHTML = `
            <div class="product-detail-page">
                ...
                <div class="info">
                    ...
                    <div class="actions">
                        ${!isOwner && currentUser && produto.status === 'disponivel' ? `
                            <button class="btn-buy" onclick="solicitarTroca(${produto.id})">🔄 Solicitar Troca</button>
                        ` : ''}
                        ${currentUser && !isOwner ? `
                            <button class="btn-chat" onclick="abrirChatProduto(${produto.id}, '${produto.dono}')">💬 Falar com vendedor</button>
                        ` : ''}
                        ${!currentUser ? `
                            <button class="btn-buy" onclick="window.location.href='index.html'">🔒 Faça login</button>
                        ` : ''}
